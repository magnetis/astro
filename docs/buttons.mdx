...
Ghost buttons are visually similar to inline links, but with the size and behavior of regular buttons.
...
For inline links in paragraphs and informative texts. If you're looking for buttons in `<a>` tags, see "buttons in `<a>` elements" below.
