...
<Playground>
  <button className='a-btn a-btn--uranus a-btn--medium a-btn--iconlabel'>
    <i class="a-icon a-icon__calendar a-icon--size-big" />
    iconlabel
  </button>
  ...
  <button className='a-btn a-btn--uranus a-btn--medium a-btn--iconlabel a-btn--iconlabel--right' disabled>
    iconlabel
    <i class="a-icon a-icon__calendar a-icon--size-big" />
  </button>
</Playground>
...
<Playground>
  ...
  <button className='a-btn a-btn--outline-uranus a-btn--medium a-btn--iconlabel a-btn--iconlabel--right' disabled>
    iconlabel
    <i class="a-icon a-icon__calendar a-icon--size-big" />
  </button>
</Playground>
...
<Playground>
  ...
  <button className='a-btn a-btn--ghost-uranus a-btn--medium a-btn--iconlabel a-btn--iconlabel--right' disabled>
    iconlabel
    <i class="a-icon a-icon__calendar a-icon--size-big" />
  </button>
</Playground>
...
<Playground>
  ...
  <button className='a-btn a-btn--uranus a-btn--medium a-btn--icon' disabled>
    ...
    <button className='a-btn a-btn--outline-uranus a-btn--medium a-btn--icon' disabled>
    <i class="a-icon a-icon__calendar a-icon--size-big" />
  </button>
</Playground>
...
<Playground>
  ...
  <button className='a-btn a-btn--uranus a-btn--iconlabel a-btn--large'>
    <i class="a-icon a-icon__calendar a-icon--size-huge" />
    iconlabel large
  </button>
</Playground>
