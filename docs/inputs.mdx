...
Inputs that have specific structure for certain kinds of data.

The masked inputs need a [mask plugin](https://github.com/RobinHerbots/Inputmask) and custom JS to work on your project. You may find the code for this working example in our GitHub repository.

<Playground className='two-columns masked-inputs'>
  <div className='a-input'>
    <input
      id='inputdate'
      type='text'
  ...
  <div className='a-input'>
    <input
      ...
      data-inputmask-digitsoptional='true'
    />
  ...
  <div className='a-input'>
    <input
      ...
      data-inputmask-placeholder='000.000.000-00'
    />
...
<Playground className='two-columns'>
  ...
  <div className='a-input a-input--control a-input--disabled'>
    ...
    <button
      className='a-btn a-btn--ghost-uranus a-btn--small a-btn--icon a-input--control__decrement'
      disabled
    >
      <i className='a-icon a-icon__input-dash a-icon--size-small' />
    </button>
    <button
      className='a-btn a-btn--ghost-uranus a-btn--small a-btn--icon a-input--control__increment'
      disabled
    >
      <i className='a-icon a-icon__input-plus a-icon--size-small' />
    </button>
