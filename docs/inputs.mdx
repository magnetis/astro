...
Inputs used for messaging and similar contexts. These inputs come with [icon buttons](/docs-buttons#icon-buttons) as commands that send away these values and contents.
...
<Playground className='two-columns'>
  <div className='a-input a-input--messaging'>
    ...
    <button className='a-btn a-btn--medium a-btn--icon'>
  ...
  <div className='a-input a-input--messaging a-input--disabled'>
    <input
      ...
      disabled
    />
    <button className='a-btn a-btn--medium a-btn--icon' disabled>
      <i className='a-icon a-icon__arrow-right a-icon--size-medium' />
    </button>
  </div>
</Playground>
