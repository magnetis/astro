...
Masked inputs don't need specific CSS classes other than the main one shown below. However, they do need a [mask plugin](https://github.com/RobinHerbots/Inputmask) and custom JS to work on your project. You may find the code for this working example in our GitHub repository. If you decide to use Inputmask like we did, please follow the example to get the same results.
...
<Playground className='two-columns masked-inputs'>
  ...
  <div className='a-input'>
    <input
      ...
      data-inputmask-placeholder=''
      data-inputmask-digitsoptional='false'
      data-inputmask-jitmasking='true'
