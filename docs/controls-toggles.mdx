...
<Playground>
  <div className="a-tabs">
    <input className="a-tabs__item" type="radio" id="tab1" name="tabs1" />
    <label className="a-tabs__label" for="tab1">Tab 1</label>
    ...
    <label className="a-tabs__label" for="tab2">Tab 2</label>
    <div className="a-tabs__content">
    ...
    <label className="a-tabs__label" for="tab3">Tab 3</label>
    <div className="a-tabs__content">
