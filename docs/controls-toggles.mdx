...
<Playground>
  <div className="a-tabs">
    ...
    <label className="a-tabs__label" for="tab1">
      <i className="a-icon a-icon__calendar a-icon--space-right a-tabs__icon" />
      <span className="a-tab__text">Tab 1</span>
    </label>
    ...
    <label className="a-tabs__label" for="tab2">
      <i className="a-icon a-icon__mail a-icon--space-right a-tabs__icon" />
      <span className="a-tab__text">Tab 2</span>
    </label>
    <div className="a-tabs__content">
    ...
    <label className="a-tabs__label" for="tab3">
      <i className="a-icon a-icon__profile a-icon--space-right a-tabs__icon" />
      <span className="a-tab__text">Tab 3</span>
    </label>
    <div className="a-tabs__content">
    ...
    <label className="a-tabs__label" for="tab4">
      <span className="a-tab__text">Tab 4</span>
    </label>
    <div className="a-tabs__content">
