...
To disabled state, add the `a-radio--disabled` modifier class on element root and `disabled` attribute on the `<input>` tag.
...
To disabled state, add the `a-checkbox--disabled` modifier class on element root and `disabled` attribute on the `<input>` tag.
...
To disabled state, add the `a-toggle--disabled` modifier class on element root and `disabled` attribute on the `<input>` tag.
...
To disabled state, add the `a-slider--disabled` modifier class on element root and `disabled` attribute on the `<input>` tag.
